...
// void Ledstrip::setPixColor(int pix_, int col_) {
//   // Set color for one pixel using its index number
//   // this->strip.setPixel(pix_, col_);
// }
...
//      this->strip.setPixel(i, this->BLACK);
//   } 
...
//    this->strip.setPixel(ledprog_ + i, col_);
//   }
...
//   for(int i=0; i<progPix_;i++){
//    this->strip.setPixel(ledprog_ + this->inside1 - i - 1, col_);
//   }
...
//     for(int i=0; i<progPix_;i++){
//      this->strip.setPixel(ledprog_ + this->inside2 - i - 1, col_);
//     }
...
//     for(int i=0; i<progPix_;i++){
//      this->strip.setPixel(ledprog_ + this->inside4 + this->outside4 + this->outside3 - i - 1, col_);
//     }
...
//     for(int i=0; i<progPix_;i++){
//      this->strip.setPixel(ledprog_ + this->inside4 + this->outside4 + this->outside3 + i, col_);
//     }
//   }
...
//     for(int i=0; i<=progPix_;i++){
//      this->strip.setPixel(ledprog_ + this->inside4 + this->outside4 - i - 1, col_);
//     }
...
//   // Shut down half led for power limit (optional)
//   for(int i=0;i<this->nPix;i++){
//     if(i%2 != 0){
//      this->strip.setPixel(i, this->BLACK);
//     }
